...
def verify_frontend():
    with sync_playwright() as p:
        ...
        # Take a screenshot
        page.screenshot(path="verification/settings_remote_notice_v2.png", full_page=True)

        # Check if the notice is visible (searching for new text)
        notice = page.locator("text=Gemma 4 / Qwen 2.5 / Jinja Notice")
